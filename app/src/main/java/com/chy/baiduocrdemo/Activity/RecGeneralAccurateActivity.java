...
/**
 * 通用文字识别服务高精度版的Activity-------高精度
 *
 * @author CHY
 * Create at 2017/12/6 15:57.
 */
public class RecGeneralAccurateActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static void start(Context context) {
        Intent intent = new Intent(context, RecGeneralAccurateActivity.class);
    ...
    private void initView() {
        ...
        mIntroduceTv.setText("免费版-----高精度的识别图片中的文字信息，没有位置信息；每天最高500次识别");
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.tv_begin_recognize:  // 通用文字识别---高精度版
                BaiduOCRUtil.openOCRWithOcrUi(this, REC_GENERAL_ACCURATE);
                break;
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        // 识别成功回调，通用文字识别----高精度
        if (requestCode == REC_GENERAL_ACCURATE && resultCode == Activity.RESULT_OK) {
            BaiduOCRUtil.recognizeOCR(REC_GENERAL_ACCURATE,
